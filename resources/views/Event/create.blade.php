...
<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <div id="form">
        <form method="POST" data-action="{{ route('events.store') }}" enctype="multipart/form-data" id="store-event">
            @csrf
            <div class="form-group">
                <label for="title">Title</label>
                <input type="text" class="form-control" id="title" placeholder="Enter the Title" minlength="3" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="location" placeholder="location" minlength="5">
            </div>
            <div class="form-group">
...
<script>
    ...
    $(document).ready(function () {
        $('#store-event').on('submit', function (event) {
